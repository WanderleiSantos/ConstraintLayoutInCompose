package com.example.appderestaurante.list_item
...
fun FoodItem(
    ...
    ConstraintLayout(
        ...
        Image(painter = painterResource(imagemFood!!), contentDescription = null,
            modifier = Modifier
                .constrainAs(imgFood) {
        ...
        Text(
            ...
            maxLines = 3,
            modifier = Modifier
                .constrainAs(txtFoodCescription) {
        ...
        Text(
            ...
            modifier = Modifier.constrainAs(txtPrice) {
                top.linkTo(txtFoodCescription.bottom, 20.dp)
                start.linkTo(containerImg.end, 0.dp)
            }
        )
        ...
        Button(onClick = { /*TODO*/ },
            modifier = Modifier
                ...
                .constrainAs(btAddCart) {
                    top.linkTo(txtFoodCescription.bottom, 10.dp)
